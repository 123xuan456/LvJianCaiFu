...
public class MyAdapter_jishuzhanshi extends BaseAdapter {
	private Context context;
	private List<Map<String, Object>> list;
	private static ImageLoader imageLoader = ImageLoader.getInstance();
	private ImageWorker mImageLoader;

	public MyAdapter_jishuzhanshi(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(
					R.layout.chanpin_item_jishuzhanshiandchenggonganli, null);
			holder = new ViewHolder();
			holder.t_jishuzhanshi_xinwenbiaoti = (TextView) convertView
					.findViewById(R.id.t_jishuzhanshi_xinwenbiaoti);
			holder.jishuzhanshi_time = (TextView) convertView
					.findViewById(R.id.jishuzhanshi_time);
		...
		holder.jishuzhanshi_time.setText(list.get(position).get("time")
				.toString());
