...
public class ChengGongAnLiActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pullToRefresh.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(ChengGongAnLiActivity.this,
						ChenggonganlixiangqingActivity.class);
	...
	private String getUrl(HashMap<String, Integer> params) {
		...
		String PATH = Constants.CHENGGONGANLI;
		...
		protected void onPostExecute(String result) {
			...
			if (result != null) {
				...
				adapter = new MyAdapter_jishuzhanshi(
						ChengGongAnLiActivity.this, list);
				pullToRefresh.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				//dialog.dismiss();
			} else if (result == null) {
				Toast.makeText(ChengGongAnLiActivity.this, "请求数据失败...",
	...
	public List<Map<String, Object>> JSONAnalysis(String result) {
		...
		try {
			...
			if (aab.equals("a")) {
				...
				Toast.makeText(ChengGongAnLiActivity.this, "没有更多数据了",
