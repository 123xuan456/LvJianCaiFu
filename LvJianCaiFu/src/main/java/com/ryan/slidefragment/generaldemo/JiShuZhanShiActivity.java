...
public class JiShuZhanShiActivity extends Activity implements OnClickListener {
	private PullToRefreshListView pullToRefresh;
	private MyAdapter_jishuzhanshi adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ji_shu_zhan_shi);
		...
		sick_title_mid_tv.setText("技术展示");
...
//						Toast.LENGTH_SHORT).show();
				...
				Intent mIntent = new Intent(JiShuZhanShiActivity.this,
						JishuzhanshixiangqingActivity.class);
	...
	private String getUrl(HashMap<String, Integer> params) {
		...
		String PATH = Constants.JISHUZHANSHI;
//		String PATH1 = Constants.JISHUZHANSHIXIANGQING;
	...
	class MyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result != null) {
				...
				adapter = new MyAdapter_jishuzhanshi(JiShuZhanShiActivity.this, list);
				pullToRefresh.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				//dialog.dismiss();
			} else if (result == null) {
				Toast.makeText(JiShuZhanShiActivity.this, "请求数据失败...",
	...
	public List<Map<String, Object>> JSONAnalysis(String result) {
		...
		try {
			...
			JSONArray a1_xinwen = jj1_xinwen.getJSONArray("jishu");
			...
			if (aab.equals("a")) {
				...
				Toast.makeText(JiShuZhanShiActivity.this, "没有更多数据了", Toast.LENGTH_SHORT).show();
//				pullToRefresh.setMode(Mode.BOTH);
