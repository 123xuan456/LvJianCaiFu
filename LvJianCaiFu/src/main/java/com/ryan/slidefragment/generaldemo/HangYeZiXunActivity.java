...
public class HangYeZiXunActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hang_ye_zi_xun);
		...
		sick_title_mid_tv.setText("行业资讯");
...
//		dialog.setMessage("正在加载...");
		...
		pullToRefresh.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(HangYeZiXunActivity.this,
...
//	}
	...
	private String getUrl(HashMap<String, Integer> params) {
		...
		String PATH = Constants.HANGYEZIXUN;
	...
	class MyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result != null) {
				...
				adapter = new MyAdapter(HangYeZiXunActivity.this, list);
				pullToRefresh.setAdapter(adapter);
				adapter.notifyDataSetChanged();
			//	dialog.dismiss();
			} else if (result == null) {
				Toast.makeText(HangYeZiXunActivity.this, "请求数据失败...",
	...
	public List<Map<String, Object>> JSONAnalysis(String result) {
		...
		try {
			...
			JSONArray a1_xinwen = jj1_xinwen.getJSONArray("zixun");
			...
			if (aab.equals("a")) {
				...
				Toast.makeText(HangYeZiXunActivity.this, "没有更多数据了", Toast.LENGTH_SHORT).show();
//				pullToRefresh.setMode(Mode.BOTH);
