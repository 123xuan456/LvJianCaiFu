...
public class TongZhiGongGaoActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tong_zhi_gong_gao);
		...
		sick_title_mid_tv.setText("通知公告");
		...
		pullToRefresh.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(TongZhiGongGaoActivity.this,
						LimengxinwengengduozhengwenActivity.class);
	...
	private String getUrl(HashMap<String, Integer> params) {
		...
		String PATH = Constants.TONGZHIGONGGAO;
	...
	class MyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result != null) {
				...
				adapter = new MyAdapter(TongZhiGongGaoActivity.this, list);
				pullToRefresh.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				//dialog.dismiss();
			} else if (result == null) {
				Toast.makeText(TongZhiGongGaoActivity.this, "请求数据失败...",
	...
	public List<Map<String, Object>> JSONAnalysis(String result) {
		...
		try {
			...
			JSONArray a1_xinwen = jj1_xinwen.getJSONArray("tongzhi");
			...
			if (aab.equals("a")) {
				...
				Toast.makeText(TongZhiGongGaoActivity.this, "没有更多数据了", Toast.LENGTH_SHORT).show();
//				pullToRefresh.setMode(Mode.BOTH);
