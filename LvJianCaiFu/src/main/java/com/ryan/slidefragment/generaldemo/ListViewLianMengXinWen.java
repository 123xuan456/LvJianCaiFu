...
public class ListViewLianMengXinWen extends BaseActivity implements
		OnClickListener {
	...
	public void findView() {
		...
		sick_title_mid_tv.setText("联盟新闻");
...
//				params.clear();
		...
		pullToRefresh.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// Toast.makeText(ListViewLianMengXinWen.this,
				// "您点击了"+list.get(position).get("id"),
				// Toast.LENGTH_SHORT).show();
				Person mPerson = new Person();
				mPerson.setName(list.get(position - 1).get("id"));
				Intent mIntent = new Intent(ListViewLianMengXinWen.this,
	...
	private String getUrl(HashMap<String, Integer> params) {
		String PATH = Constants.LIANMENGXINWENLISTVIEW;
	...
	class MyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result != null) {
				...
				adapter = new MyAdapter(ListViewLianMengXinWen.this, list);
				pullToRefresh.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				//dialog.dismiss();
			} else if (result == null) {
				Toast.makeText(ListViewLianMengXinWen.this, "请求数据失败...",
	...
	public List<Map<String, Object>> JSONAnalysis(String result) {
		...
		try {
			...
			JSONArray a1_xinwen = jj1_xinwen.getJSONArray("quanbu");
			...
			if (aab.equals("a")) {
				...
				Toast.makeText(ListViewLianMengXinWen.this, "没有更多数据了",
						Toast.LENGTH_SHORT).show();
				// pullToRefresh.setMode(Mode.BOTH);
