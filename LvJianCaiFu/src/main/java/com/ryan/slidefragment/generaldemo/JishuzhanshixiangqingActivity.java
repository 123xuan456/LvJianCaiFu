...
OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_jishuzhanshixiangqing);
	...
	private String getUrl(HashMap<String, String> params) {
		PATH=Constants.JISHUZHANSHIXIANGQING;
		// 添加url参数
		if (params != null) {
