...
import com.ryan.slidefragment.adapter.MyAdapter;
...
public class LianmengzhengceActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_lianmengzhengce);
		...
		sick_title_mid_tv.setText("联盟政策");
		...
		pullToRefresh.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(LianmengzhengceActivity.this,
						ZhengcexiangqingActivity.class);
	...
	private String getUrl(HashMap<String, Integer> params) {
		...
		String PATH = Constants.LIANMENGZHENGCE;
	...
	class MyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result != null) {
				...
				adapter = new MyAdapter(LianmengzhengceActivity.this, list);
				pullToRefresh.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				//dialog.dismiss();
			} else if (result == null) {
				Toast.makeText(LianmengzhengceActivity.this, "请求数据失败...",
	...
	public List<Map<String, Object>> JSONAnalysis(String result) {
		...
		try {
			...
			JSONArray a1_xinwen = jj1_xinwen.getJSONArray("lianmengzhengce");
			...
			for (int i = 0; i < a1_xinwen.length(); i++) {
				...
				String time = objectOne.optString("time");
			...
			if (aab.equals("a")) {
				...
				Toast.makeText(LianmengzhengceActivity.this, "没有更多数据了", Toast.LENGTH_SHORT).show();
//				pullToRefresh.setMode(Mode.BOTH);
