...
public class ActivityChanPinListView extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sick_title_mid_tv.setText("产品列表");
...
//		dialog.setMessage("正在加载...");
		// Toast.makeText(this, getUrl(params), Toast.LENGTH_SHORT).show();
		...
		pullToRefresh.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(ActivityChanPinListView.this,
						BabyActivity.class);
	...
	private String getUrl(HashMap<String, String> params) {
		...
		String PATH = Constants.CHANPINLISTVIEW;
	...
	class MyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			if (result != null) {
				...
				adapter = new MyAdapter_jishuzhanshi(
						ActivityChanPinListView.this, list);
				pullToRefresh.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				//dialog.dismiss();
			} else if (result == null) {
				Toast.makeText(ActivityChanPinListView.this, "请求数据失败...",
	...
	public List<Map<String, Object>> JSONAnalysis(String result) {
		...
		try {
			...
			JSONArray a1_xinwen = jj1_xinwen.getJSONArray("chanpin");
			...
			for (int i = 0; i < a1_xinwen.length(); i++) {
				...
				String name = objectOne.optString("name");
