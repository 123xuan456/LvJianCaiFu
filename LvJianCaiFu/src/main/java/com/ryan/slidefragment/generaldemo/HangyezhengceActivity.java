...
public class HangyezhengceActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_hangyezhengce);
		...
		sick_title_mid_tv.setText("行业政策");
		...
		pullToRefresh.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent mIntent = new Intent(HangyezhengceActivity.this,
	...
	private String getUrl(HashMap<String, Integer> params) {
		...
		String PATH = Constants.HANGYEZHENGCE;
	...
	class MyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			if (result != null) {
				...
				adapter = new MyAdapter(HangyezhengceActivity.this, list);
				pullToRefresh.setAdapter(adapter);
				adapter.notifyDataSetChanged();
				//dialog.dismiss();
			} else if (result == null) {
				Toast.makeText(HangyezhengceActivity.this, "请求数据失败...",
	...
	public List<Map<String, Object>> JSONAnalysis(String result) {
		...
		try {
			...
			JSONArray a1_xinwen = jj1_xinwen.getJSONArray("hangyezhengce");
			...
			if (aab.equals("a")) {
				...
				Toast.makeText(HangyezhengceActivity.this, "没有更多数据了", Toast.LENGTH_SHORT).show();
//				pullToRefresh.setMode(Mode.BOTH);
