package com.ryan.slidefragment.tourongzi.activity.zhaoxiangmu.shougou;
...
public class ShouGouActivity extends Activity  implements OnClickListener{
	...
	private void setView() {
		...
		pullToRefresh.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
				...
				Intent i1 = new Intent(ShouGouActivity.this, ZhaoXiangMu_xiangqing.class);
				i1.putExtra("id", id);
				startActivity(i1);
			}
		});
