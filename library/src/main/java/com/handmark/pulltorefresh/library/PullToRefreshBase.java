...
//		mRefreshableViewWrapper.addView(topImageView);
	}
...
//		topImageView = createTopImageView(context);
//		setTopImageViewShow(false);
...
//	private ImageView createTopImageView(Context context){
//		
//		View view = View.inflate(context, R.layout.top_image, null);
////		topImageView = new ImageView(context);
//		topImageView = (ImageView)view.findViewById(R.id.iv_top);
//		RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(dip2px(context,40),dip2px(context,40));
////		params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT, RelativeLayout.TRUE); 
////		params.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM, RelativeLayout.TRUE); 
//		topImageView.setLayoutParams(params);
////		topImageView.setImageDrawable(getResources().getDrawable(R.drawable.dingbu));
//		return topImageView;
//	}
...
//	}
//	public void setTopImageViewShow(boolean show){
//		if(show){
